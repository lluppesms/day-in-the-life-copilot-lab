...
BUILD_OUTPUT=$(dotnet build src/ContosoUniversity.sln --nologo --verbosity quiet 2>&1) || {
...
$output = dotnet build src/ContosoUniversity.sln --nologo --verbosity quiet 2>&1
...
export FILE_PATH="src/ContosoUniversity.Web/Controllers/StudentsController.cs"
bash scripts/hooks/post-tool-use-dotnet-build.sh
```
...
```powershell
$env:TOOL_NAME = "edit"
$env:FILE_PATH = "src/ContosoUniversity.Web/Controllers/StudentsController.cs"
